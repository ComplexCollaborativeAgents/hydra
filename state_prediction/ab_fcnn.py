...
if __name__ == '__main__':
    ...
    trainval_set = ABDataset('data_2021416_preproc', mode='train')
    test_set = ABDataset('data_2021416_preproc', mode='test')
    novelty_set = ABDataset('data_2021416_preproc', mode='Level_1_6')
