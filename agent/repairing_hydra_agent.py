...
from agent.consistency.model_repair import ModelRepair
...
class RepairingHydraAgent(HydraAgent):
    ...
    def __init__(self,env=None):
        super(RepairingHydraAgent, self).__init__()
        self.meta_model = MetaModel()
        self.model_repair = ModelRepair()
    ...
    def handle_new_training_set(self, state):
    ...
    def handle_game_lost(self, state):
    ...
    def handle_game_won(self, state):
    ...
    def handle_playing(self, state):
        ...
        logger.info("[hydra_agent_server] :: Reward {} Game State {}".format(reward, next_state.game_state))

        # Model repair
        # self.model_repair.repair(self.meta_model, state, action, next_state, self.env)
