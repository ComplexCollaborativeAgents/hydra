from utils.polycraft_utils import has_new_item, get_new_entity_items, compute_cell_distance
...
class PolyBreakAndCollect(PolycraftAction):
    ...
    def do(self, poly_client: poly.PolycraftInterface) -> dict:
        ...
        post_tp_to_state = PolycraftState.create_current_state(poly_client)
        state_diff = post_tp_to_state.diff(post_break_state)
