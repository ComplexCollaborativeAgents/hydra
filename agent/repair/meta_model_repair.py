...
class SimulationBasedMetaModelRepair(MetaModelRepair):
    ...
    def _compute_consistency(self, repair: list, observation):
    ...
    def expand(self, repair):
        ...
        for i, fluent in enumerate(self._fluents_to_repair):
            if repair[i] >= 0:
                ...
                if self.current_meta_model.constant_numeric_fluents[self._fluents_to_repair[i]] + change_to_fluent >= 0: # Don't allow negative fluents TODO: Discuss
