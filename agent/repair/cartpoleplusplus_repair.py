...
class CartpolePlusPlusConsistencyEstimator(DomainConsistency):
    def __init__(self):
        super(CartpolePlusPlusConsistencyEstimator, self).__init__([CartPlusPlusLocationConsistency(), CartPlusPlusBlockConsistency()])
...
class CartPlusPlusLocationConsistency(AspectConsistency):
    ...
    def __init__(self, fluent_names=None, obs_prefix=100, discount_factor=0.9, consistency_threshold=0.01):
        ...
        super().__init__(fluent_names=fluent_names, obs_prefix=obs_prefix, discount_factor=discount_factor, consistency_threshold=consistency_threshold)
...
class CartPlusPlusBlockConsistency(AspectConsistency):
    """ Checks consistency by considering the location of the Cartpole fluents """
