...
class SBHydraAgent(HydraAgent):
    ...
    def main_loop(self, max_actions=1000):
        ...
        while True:
            ...
            observation = SBEpisodeLog()  # Create an observation object to track on what happend
    ...
    def _record_novelty_indicators(self, observation: SBEpisodeLog):
    ...
    def choose_action(self, observation: SBEpisodeLog):
...
class RepairingSBHydraAgent(SBHydraAgent):
    ...
    def should_repair(self, observation: SBEpisodeLog):
        """
