...
class ClientNaiveAgent(Thread):
    ...
    def __init__(self):
        ...
        with open('worlds/science_birds_interface/client/server_observer_client_config.json', 'r') as observer_config:
    ...
    def sample_state(self, request = RequestCodes.GetGroundTruthWithoutScreenshot, frequency = 1):
        """
