 ...
 (<= (block_stability ?bl_bottom)  0)
	...
	(:event explode_block
		...
		:precondition (and 
		 ...
		 (<= (- (x_block ?bl_tnt)  (x_block ?bl_near) )
 70)
		 (>= (- (x_block ?bl_tnt)  (x_block ?bl_near) )
 -70)
		 (<= (- (y_block ?bl_tnt)  (y_block ?bl_near) )
 70)
		 (>= (- (y_block ?bl_tnt)  (y_block ?bl_near) )
 -70)
		) 
	...
	(:event explode_pig
		...
		:precondition (and 
		 ...
		 (<= (block_life ?bl_tnt)  0)
		 (not (pig_dead ?p) )
		 (<= (- (x_block ?bl_tnt)  (x_pig ?p) )
 50)
		 (>= (- (x_block ?bl_tnt)  (x_pig ?p) )
 -50)
		 (<= (- (y_block ?bl_tnt)  (y_pig ?p) )
 50)
		 (>= (- (y_block ?bl_tnt)  (y_pig ?p) )
 -50)
		) 
