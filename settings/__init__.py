...
SCIENCE_BIRDS_LEVELS_DIR = path.join(SCIENCE_BIRDS_BIN_DIR, 'linux', '9001_Data', 'StreamingAssets', 'Levels')
...
# SB_GT_FREQ = 1
SB_CLASSIFICATION_THRESHOLD = 0.65
SB_N_FRAMES = 100
...
SB_CONSISTENCY_THRESHOLD = 5
SB_ANOMOLY_DETECTOR_THRESHOLD = 0.55
SB_SHOULD_REPAIR_THRESHOLD = 10


SB_REWARD_CONSISTENCY_THRESHOLD = 0.5
SB_LEVEL_NOVELTY_DETECTION_ENSEMBLE_THRESHOLD = None
#SB_LEVEL_NOVELTY_DETECTION_ENSEMBLE_THRESHOLD = 0.8
SB_LOOKBACK_HORIZON = 5
SB_LOOKBACK_ONLY_DETECTION = False
